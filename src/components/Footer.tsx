        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <div className="flex space-x-4">
              <a 
                href="https://www.facebook.com/people/Telugumobilecoder/61573583755565/" 
              ...
              <a
                href="https://www.instagram.com/telugumobilecoder?igsh=dWFoc2hkZTdxdnJh"
                className="bg-background p-2 rounded-full text-muted-foreground hover:text-primary hover:bg-primary/10 transition-colors"
              ...
              <a 
                href="https://www.linkedin.com/in/venkataramanau/" 
                className="bg-background p-2 rounded-full text-muted-foreground hover:text-primary hover:bg-primary/10 transition-colors"
                aria-label="LinkedIn"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
